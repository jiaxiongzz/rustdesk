...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cw.yiliacc.com"];
pub const PUBLIC_RS_PUB_KEY: &str = "iSrVxvVHHuwHmdBA4OSa5tUa3azr1C2n743VATygV2k=";
...
pub const RENDEZVOUS_PORT: i32 = 8382;
pub const RELAY_PORT: i32 = 8383;
